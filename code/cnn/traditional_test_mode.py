...
checkpoint = torch.load('./cnn_traditional_data-driven_train_mode.pth')
model = ConvNet(input_dim=7,hidden_dim=1,kernel_size1=(7,3,3),padding1=(0,1,1),kernel_size2=(1,3,3),padding2=(0,1,1))
...
pred_test1 = pred_test.reshape(-1,1).detach().cpu().numpy()
